//
//  LPManyImageViewViewController.m
//  LePin-Ent
//
...
@interface LPManyImageViewViewController ()<UIAlertViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UITextFieldDelegate,UIActionSheetDelegate>
{
    BOOL deleBool;
    BOOL ifSava;
}
...
@implementation LPManyImageViewViewController
...
- (void)getNAV
{
    ...
    UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake((w-130)/2, 18, 130, 55)];
    label.text = @"我们的荣誉证书";
    ...
    [self.completeBut addTarget:self action:@selector(complete) forControlEvents:UIControlEventTouchUpInside];
...
- (void)getManyImage
{
    ...
    self.completeBut.layer.borderWidth = 1;
    self.completeBut.layer.borderColor = [UIColor orangeColor].CGColor;
    self.completeBut.layer.cornerRadius = 5;
    self.completeBut.layer.masksToBounds = YES;
    ...
    if (_model.strengthListArr.count > 0) {
        [_image1 setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",IMAGEPATH,_model.strengthListArr[0][@"PATH"]]]];
        _textfield1.text = _model.strengthListArr[0][@"TEXT"];
    }
    if (_model.strengthListArr.count > 1){
    [_image2 setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",IMAGEPATH,_model.strengthListArr[1][@"PATH"]]]];
        _textfield2.text = _model.strengthListArr[1][@"TEXT"];}
    if (_model.strengthListArr.count > 2){
    
    [_image3 setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",IMAGEPATH,_model.strengthListArr[2][@"PATH"]]]];
        _textfield3.text = _model.strengthListArr[2][@"TEXT"];}
    if (_model.strengthListArr.count > 3){
    
    [_image4 setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",IMAGEPATH,_model.strengthListArr[3][@"PATH"]]]];
        _textfield4.text = _model.strengthListArr[3][@"TEXT"];}
    if (_model.strengthListArr.count > 4){
    [_image5 setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",IMAGEPATH,_model.strengthListArr[4][@"PATH"]]]];
        _textfield5.text = _model.strengthListArr[4][@"TEXT"];}
    if (_model.strengthListArr.count > 5){
        [_image6 setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",IMAGEPATH,_model.strengthListArr[5][@"PATH"]]]];
        _textfield6.text = _model.strengthListArr[5][@"TEXT"];}
...
//            _deleBut1.enabled = NO;
        ...
        if (_image2.image.size.height != size.height && _image2.image.size.width != size.width) {
//            _image2.userInteractionEnabled = NO;
//            _deleBut2.enabled = NO;
            [MBProgressHUD showError:@"您没有权限，请联系主帐号操作"];
            return;
        }
        if (_image3.image.size.height != size.height && _image3.image.size.width != size.width) {
            [MBProgressHUD showError:@"您没有权限，请联系主帐号操作"];
            return;
//            _image3.userInteractionEnabled = NO;
//            _deleBut3.enabled = NO;
        }
        if (_image4.image.size.height != size.height && _image4.image.size.width != size.width) {
            [MBProgressHUD showError:@"您没有权限，请联系主帐号操作"];
            return;
//            _image4.userInteractionEnabled = NO;
//            _deleBut4.enabled = NO;
        }
        if (_image5.image.size.height != size.height && _image5.image.size.width != size.width) {
            [MBProgressHUD showError:@"您没有权限，请联系主帐号操作"];
            return;
//            _image5.userInteractionEnabled = NO;
//            _deleBut5.enabled = NO;
        }
        if (_image6.image.size.height != size.height && _image6.image.size.width != size.width) {
            [MBProgressHUD showError:@"您没有权限，请联系主帐号操作"];
            return;
//            _image6.userInteractionEnabled = NO;
//            _deleBut6.enabled = NO;
        }
        if (_textfield1.text.length > 0) {
            _textfield1.enabled = NO;
...
- (void)get:(NSMutableDictionary *)params
{
    ...
    if (!_path1Str) {
        NSLog(@"111222");
        if (_model.strengthListArr.count > 0) {
            params[@"STRENGTH_PHOTO1"] = _model.strengthListArr[0][@"PATH"];
        }
//            else{return;}
    }else{NSLog(@"111222222222");
        params[@"STRENGTH_PHOTO1"] = _path1Str ;}
      if (!_textfield1.text) { params[@"STRENGTH_PHOTO1_TEXT"] = _model.strengthListArr[0][@"TEXT"];}else {params[@"STRENGTH_PHOTO1_TEXT"] = _textfield1.text;}
    
    
    if (!_path2Str) {
        NSLog(@"111222");
        if (_model.strengthListArr.count > 1){
            params[@"STRENGTH_PHOTO2"] = _model.strengthListArr[1][@"PATH"];
    }
//    else{return;}
    }else{NSLog(@"111222222222");
        params[@"STRENGTH_PHOTO2"] = _path2Str ;}
    
    if (!_textfield2.text) { params[@"STRENGTH_PHOTO2_TEXT"] = _model.strengthListArr[1][@"TEXT"];}else {params[@"STRENGTH_PHOTO2_TEXT"] = _textfield2.text;}
    
    
    if (!_path3Str) {
        NSLog(@"111222");
        if (_model.strengthListArr.count > 2){
            params[@"STRENGTH_PHOTO3"] = _model.strengthListArr[2][@"PATH"];
    }
//            else{return;}
    }else{NSLog(@"111222222222");
        params[@"STRENGTH_PHOTO3"] = _path3Str ;}
    if (!_textfield3.text) { params[@"STRENGTH_PHOTO3_TEXT"] = _model.strengthListArr[2][@"TEXT"];}else {params[@"STRENGTH_PHOTO3_TEXT"] = _textfield3.text;}
    
    
    if (!_path4Str) {
        NSLog(@"111222");
        if (_model.strengthListArr.count > 3){
            params[@"STRENGTH_PHOTO4"] = _model.strengthListArr[3][@"PATH"];
    }
//            else{return;}
    }else{NSLog(@"111222222222");
        params[@"STRENGTH_PHOTO4"] = _path4Str ;}
    if (!_textfield4.text) { params[@"STRENGTH_PHOTO4_TEXT"] = _model.strengthListArr[3][@"TEXT"];}else {params[@"STRENGTH_PHOTO4_TEXT"] = _textfield4.text;}
    
    
    if (!_path5Str) {
        NSLog(@"111222");
        if (_model.strengthListArr.count > 4){
            params[@"STRENGTH_PHOTO5"] = _model.strengthListArr[4][@"PATH"];
    }
//            else{return;}
    }else{NSLog(@"111222222222");
        params[@"STRENGTH_PHOTO5"] = _path5Str ;}    
    if (!_textfield5.text) { params[@"STRENGTH_PHOTO5_TEXT"] = _model.strengthListArr[4][@"TEXT"];}else {params[@"STRENGTH_PHOTO5_TEXT"] = _textfield5.text;}
    
    if (!_path6Str) {
        NSLog(@"111222");
        if (_model.strengthListArr.count > 5){
            params[@"STRENGTH_PHOTO6"] = _model.strengthListArr[5][@"PATH"];
    }
//            else{return;}
    }else{NSLog(@"111222222222");
        params[@"STRENGTH_PHOTO6"] = _path6Str ;}
    if (!_textfield6.text) { params[@"STRENGTH_PHOTO6_TEXT"] = _model.strengthListArr[5][@"TEXT"];}else {params[@"STRENGTH_PHOTO6_TEXT"] = _textfield6.text;}
...

{
    ...
    int offset = frame.origin.y + 10 -10 - ( heights - 213.0-35.0);//键盘高度216
    NSLog(@"%d",offset);
...
{
     [self.view endEditing:YES];
    if (_model.strengthListArr.count < but.tag) {
        return;
    }
...
- (void)getstreng
{
    if (_model.strengthListArr.count == 6) {
        [_image1 setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",IMAGEPATH,_model.strengthListArr[1][@"PATH"]]]];
        _textfield1.text = _model.strengthListArr[1][@"TEXT"];
        _params[@"STRENGTH_PHOTO1"] = _model.strengthListArr[1][@"PATH"];
        _params[@"STRENGTH_PHOTO1_TEXT"] = _textfield1.text;
        
        [_image2 setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",IMAGEPATH,_model.strengthListArr[2][@"PATH"]]]];
        _textfield2.text = _model.strengthListArr[2][@"TEXT"];
        _params[@"STRENGTH_PHOTO2"] = _model.strengthListArr[2][@"PATH"];
        _params[@"STRENGTH_PHOTO2_TEXT"] = _textfield2.text;
        
        [_image3 setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",IMAGEPATH,_model.strengthListArr[3][@"PATH"]]]];
        _textfield3.text = _model.strengthListArr[3][@"TEXT"];;
        _params[@"STRENGTH_PHOTO3"] =  _model.strengthListArr[3][@"PATH"];
        _params[@"STRENGTH_PHOTO3_TEXT"] =  _textfield3.text;
        
        [_image4 setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",IMAGEPATH,_model.strengthListArr[4][@"PATH"]]]];
        _textfield4.text = _model.strengthListArr[4][@"TEXT"];;
        _params[@"STRENGTH_PHOTO4"] =  _model.strengthListArr[4][@"PATH"];
        _params[@"STRENGTH_PHOTO4_TEXT"] =  _textfield4.text;
        
        [_image5 setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",IMAGEPATH,_model.strengthListArr[5][@"PATH"]]] placeholderImage:[UIImage imageNamed:@"上传图片123.png"]];
        _textfield5.text = _model.strengthListArr[5][@"TEXT"];;;
        _params[@"STRENGTH_PHOTO5"] = _model.strengthListArr[5];
        _params[@"STRENGTH_PHOTO5_TEXT"] = _textfield5.text;
        
        [_image6 setImageWithURL:nil placeholderImage:[UIImage imageNamed:@"上传图片123.png"]];
        _textfield6.text = nil;
        _path6Str = nil;
        _params[@"STRENGTH_PHOTO6"] = nil;
        _params[@"STRENGTH_PHOTO6_TEXT"] = _textfield6.text;
    }
    ...
    if (_model.strengthListArr.count == 2) {
        ...
        _path2Str = nil;
        _params[@"STRENGTH_PHOTO2"] = nil;
        _params[@"STRENGTH_PHOTO2_TEXT"] = nil;
...
- (void)getstreng2
{
    ...
    if (_model.strengthListArr.count == 6) {
        [_image1 setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",IMAGEPATH,_model.strengthListArr[0][@"PATH"]]]];
        _textfield1.text = _model.strengthListArr[0][@"TEXT"];
        _params[@"STRENGTH_PHOTO1"] = _model.strengthListArr[0][@"PATH"];
        _params[@"STRENGTH_PHOTO1_TEXT"] = _textfield1.text;
...
- (void)getstreng3
{
    ...
    if (_model.strengthListArr.count == 6) {
        ...
        [_image2 setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",IMAGEPATH,_model.strengthListArr[1][@"PATH"]]]];
        _textfield2.text = _model.strengthListArr[1][@"TEXT"];
        _params[@"STRENGTH_PHOTO2"] = _model.strengthListArr[1][@"PATH"];
        _params[@"STRENGTH_PHOTO2_TEXT"] = _textfield2.text;
...
- (void)getstreng4
{
    if (_model.strengthListArr.count == 6) {
        ...
        [_image3 setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",IMAGEPATH,_model.strengthListArr[2][@"PATH"]]]];
        _textfield3.text = _model.strengthListArr[2][@"TEXT"];;
        _params[@"STRENGTH_PHOTO3"] =  _model.strengthListArr[2][@"PATH"];
        _params[@"STRENGTH_PHOTO3_TEXT"] =  _textfield3.text;
...
- (void)getstreng5
{
    if (_model.strengthListArr.count == 6) {
        ...
        [_image4 setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",IMAGEPATH,_model.strengthListArr[3][@"PATH"]]]];
        _textfield4.text = _model.strengthListArr[3][@"TEXT"];;
        _params[@"STRENGTH_PHOTO4"] =  _model.strengthListArr[3][@"PATH"];
        _params[@"STRENGTH_PHOTO4_TEXT"] =  _textfield4.text;
...
- (void)getstreng6
{
    if (_model.strengthListArr.count == 6) {
        ...
        [_image5 setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",IMAGEPATH,_model.strengthListArr[4][@"PATH"]]] placeholderImage:[UIImage imageNamed:@"上传图片123.png"]];
        _textfield5.text = _model.strengthListArr[4][@"TEXT"];;;
        _params[@"STRENGTH_PHOTO5"] = _model.strengthListArr[4];
        _params[@"STRENGTH_PHOTO5_TEXT"] = _textfield5.text;
...
- (void)boolParmsIsNil
{
    if (!_params[@"STRENGTH_PHOTO1"]) {
        _params[@"STRENGTH_PHOTO1"] = @"";
    }
    if (!_params[@"STRENGTH_PHOTO2"]) {
        _params[@"STRENGTH_PHOTO2"] = @"";
    }
    if (!_params[@"STRENGTH_PHOTO3"]) {
        _params[@"STRENGTH_PHOTO3"] = @"";
    }
    if (!_params[@"STRENGTH_PHOTO4"]) {
        _params[@"STRENGTH_PHOTO4"] = @"";
    }
    if (!_params[@"STRENGTH_PHOTO5"]) {
        _params[@"STRENGTH_PHOTO5"] = @"";
    }
    if (!_params[@"STRENGTH_PHOTO6"]) {
        _params[@"STRENGTH_PHOTO6"] = @"";
    }
    if (!_params[@"STRENGTH_PHOTO1_TEXT"]) {
        _params[@"STRENGTH_PHOTO1_TEXT"] = @"";
    }
    if (!_params[@"STRENGTH_PHOTO2_TEXT"]) {
        _params[@"STRENGTH_PHOTO2_TEXT"] = @"";
    }
    if (!_params[@"STRENGTH_PHOTO3_TEXT"]) {
        _params[@"STRENGTH_PHOTO3_TEXT"] = @"";
    }
    if (!_params[@"STRENGTH_PHOTO4_TEXT"]) {
        _params[@"STRENGTH_PHOTO4_TEXT"] = @"";
    }
    if (!_params[@"STRENGTH_PHOTO5_TEXT"]) {
        _params[@"STRENGTH_PHOTO5_TEXT"] = @"";
    }
    if (!_params[@"STRENGTH_PHOTO6_TEXT"]) {
        _params[@"STRENGTH_PHOTO6_TEXT"] = @"";
    }
